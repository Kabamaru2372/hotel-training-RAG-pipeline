...
echo "  Trigger indexer:       ADMIN_KEY=\$(az search admin-key show --service-name srch-rag-demo-001 --resource-group ${RESOURCE_GROUP} --query primaryKey -o tsv) && \\"
echo "                         curl -s -X POST 'https://srch-rag-demo-001.search.windows.net/indexers/blob-indexer/run?api-version=2024-07-01' \\"
echo "                           -H \"api-key: \$ADMIN_KEY\" -H 'Content-Length: 0'"
